...
public class User {
	...
	public User(int id, String name, int postsCount, Blob picture, String email, Date joinedOn) {
	...
	private void checkArguments(int id, String name, int postsCount, Blob picture, String email, Date joinedOn) {
